...
function Project() {
    return (
        <section className='max-w-container mx-auto lgl:px-20 py-24' id="project">
            ...
            <div className="w-full flex flex-col items-center jsutify-center gap-28 mt-10">
                <div className="flex flex-col xl:flex-row gap-6">
                    <Link href="https://my-you-tube-ftlkgbh6h-neo-ayush-jha.vercel.app/" target='_blank' className='w-full xl:w-1/2 h-auto relative group '>
                        <div>
                            <Image src={Youtube} alt='Django hospital' className='w-full h-full object-contain rounded-md ' />
                        </div>
                    </Link>
                    <div className="w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-between items-end text-right xl:-ml-16 z-10">
                        <p className='font-titleFont text-textGreen text-sm tracking-wide'>Featured Project</p>
                        ...
                        <div className='text-2xl flex gap-4'>
                            <Link className='hover:text-textGreen duration-300' target='_blank' href="https://github.com/Neo-Ayush-jha/My_YouTube" ><TbBrandGithub /></Link>
                            <Link className='hover:text-red-300 text-red-300 duration-300' target='_blank' href="https://my-you-tube-ftlkgbh6h-neo-ayush-jha.vercel.app/" ><AiOutlineYoutube /></Link>
                            <Link className='hover:text-textGreen duration-300' target='_blank' href="https://my-you-tube-ftlkgbh6h-neo-ayush-jha.vercel.app/" ><RxOpenInNewWindow /></Link>
                        </div>
                    </div>
                </div>
            </div>
